...
google.charts.load('current', {'packages':['corechart']});
      ...
      function drawChart() {
        var query = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1k76ZMJnz-oXdDVW6tbnfJ1bvR03IPpXXbL_3o2ZwB6w/gviz/tq?gid=971893759&headers=1&range=A3:F15');
	...
	function handleQueryResponse(response) {
  		var data = response.getDataTable();
        	...
        	var options = {
			title: 'Total Spell Availability per Power Cost, by Faction',
			curveType: 'function',
        	...
        	var chart = new google.visualization.LineChart(document.getElementById('chart_spells_001'));
